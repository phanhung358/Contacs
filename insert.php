...
if(isset($_POST['done'])) {
	...
	$query = "INSERT INTO `danhba`(`name`, `phone`, `email`)
		...
		<div class="col-lg-6">
			...
			<form  method="POST" class="shadow p-3">
				<div class="form-group">
					...
					<div class="">	
						<input type="text" class="form-control" name="txtName" placeholder="Tên">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label" >Số điện thoại</label>
					<div class="">
						<input type="text" class="form-control" name="txtPhone" placeholder="Số diện thoại">
					</div>
				</div>
				<div class="form-group">
